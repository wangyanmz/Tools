...
//    self.font = [UIFont fontWithName:@"PingFang SC" size:18.0f];
...
//            CGFloat stringWidth = roundf([titleString sizeWithFont:self.font].width);
            ...
            CGFloat stringWidth = roundf([titleString sizeWithAttributes:@{NSFontAttributeName : self.font}].width);
...
//            titleLayer.font = (__bridge CFTypeRef)(self.font.fontName);
            ...
            titleLayer.font = (__bridge CFTypeRef _Nullable)(name);
